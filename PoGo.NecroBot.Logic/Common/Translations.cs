...
namespace PoGo.NecroBot.Logic.Common
{
    ...
    public class Translation : ITranslation
    {
            ...
            <KeyValuePair<TranslationString, string>>
        {
            ...
            new KeyValuePair<TranslationString, string>(TranslationString.GotEnoughPokeballsToSnipe,
                "Got enough Pokeballs to start sniping! ({0}/{1})"),
