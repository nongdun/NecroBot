...
{
    public static class FarmPokestopsGetBallsTask
    {
        ...
        public static async Task Execute(ISession session, CancellationToken cancellationToken)
        {
            ...
            while (pokestopList.Any())
            {
                ...
                if(await CheckPokeballsToSnipe(Convert.ToInt16(session.LogicSettings.MaxPokeballsToSnipe),session,cancellationToken))
                {
                    return;
                }
